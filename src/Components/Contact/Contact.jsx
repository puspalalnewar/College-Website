  ...
  return (
    <div className='contact'>
      <div className="contact-col">
        ...
        <ul>
          <li><i className="fa-solid fa-envelope"></i>Contact@greatStack.dev</li>
          <li><i className="fa-solid fa-phone"></i>+1 123-567-9000</li>
          <li><i className="fa-solid fa-location-dot"></i>Alipurduar University, <br /> India</li>
        </ul>
      </div>
      <div className="contact-col">
